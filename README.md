...
<code>apt update && apt upgrade -y && apt install sudo git -y && sudo rm -rf whaticket2 && sudo git clone https://github.com/ericdbx/whaticket2.git && cd whaticket2 && sudo chmod +x ./automatizaai && ./automatizaai</code><br />
&nbsp;</p>
